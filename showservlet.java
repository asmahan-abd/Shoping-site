...
*/
        ...
        out.println("<BR><INPUT TYPE=CHECKBOX " +
                "NAME=book VALUE=\"Java Enterprise in a Nutshell\"> Java Enterprise in a Nutshell");


        out.println("<BR><INPUT TYPE=CHECKBOX " +
                "NAME=book VALUE= \"Core J2EE Patterns: Best Practicees and Design Strategies\"> Core J2EE Patterns: Best Practicees and Design Strategies");



        out.println("<BR><INPUT TYPE=CHECKBOX " +
                "NAME=book VALUE=\"EJB 3 in Action\"> EJB 3 in Action");
        out.println("<BR>");
